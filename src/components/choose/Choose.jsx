...
const Choose = () => {
  ...
  <div className="container-fluid choose-wrapper">
    ...
    <div className="left-section">
      ...
      <p>With advanced neurodiagnostic technology the best neurologists in Nashik, and a strong patient-first approach, Sahyadri ensures accurate diagnosis and effective treatment at every stage.</p>
